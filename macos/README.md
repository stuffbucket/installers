...
Pre-built installer packages for stuffbucket projects on macOS.
...
| Package | Description |
|---------|-------------|
| **stuffbucket-homebrew-1.pkg** | Sets up stuffbucket Homebrew tap |
| **stuffbucket-lima-2.pkg** | Installs Lima virtual machines |
...
The VS Code Lima extension is available through the Visual Studio Code marketplace:
